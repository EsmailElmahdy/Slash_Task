    ...
    return BlocProvider(
      ...
      child: Padding(
        padding: EdgeInsets.only(
          ...
          bottom: MediaQuery.of(context).size.height * 0.01, // Minimized bottom padding
        ),
        child: Column(
          children: [
            Row(
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        for (var product in snapshot.data!['bestSelling']!)
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            padding: EdgeInsets.only(top: screenWidth * 0.015), // Reduced top padding
            child: Text(
